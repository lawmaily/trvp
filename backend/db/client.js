...
export default class DB {
    ...
    async getStock() {
        try {
            const stock = await this.#dbClient.query(
                'SELECT * FROM public.stock ORDER BY name;'
            );
            return stock.rows;
        } catch(error) {
    ...
    async getOrders() {
        try {
            const orders = await this.#dbClient.query(
                'SELECT * FROM public.orders ORDER BY date_until;'
            );
            return orders.rows;
        } catch(error) {
            console.error(':( ERROR! Unable to get stock | ERROR = ', error);
    ...
    async getLists() {
        try {
            const lists = await this.#dbClient.query(
                'SELECT * FROM public.lists ORDER BY order_id, med;'
            );
            return lists.rows;
        } catch(error) {
            console.error(':( ERROR! Unable to get stock | ERROR = ', error);
    ...
    async getOrderList({order_id} = {order_id: null}) {
        ...
        try {
            const list = await this.#dbClient.query(
                'SELECT * FROM public.lists WHERE order_id = $1 ORDER BY med;',
                [order_id]
            );
            return list.rows;
        } catch(error) {
    ...
    async addStock({
        ...
        try {
            await this.#dbClient.query(
                'INSERT INTO public.stock (name, count, recipe_required) VALUES ($1, $2, $3);',
    ...
    async deleteStock({name} = {name: null}) {
        ...
        try {
            await this.#dbClient.query(
                'DELETE FROM public.stock WHERE name = $1;',
                [name]
            );
        } catch(error) {
    ...
    async updateStockCount({
        ...
        try {
            await this.#dbClient.query(
                'UPDATE public.stock SET count = count + $2 WHERE name = $1;',
                [name, delta]
            );
        } catch(error) {
    ...
    async addOrder({
        ...
        try {
            await this.#dbClient.query(
                'INSERT INTO public.orders (id, fio, date_until) VALUES ($1, $2, $3);',
                [id, fio, date_until]
            );
        } catch(error) {
    ...
    async updateOrder({
        ...
        try {
            await this.#dbClient.query(
                'UPDATE public.orders SET fio = $2, date_until = $3 WHERE id = $1;',
                [id, fio, date_until]
            );
        } catch(error) {
    ...
    async addList({
        ...
        try {
            await this.#dbClient.query(
                'INSERT INTO public.lists (id, med, count, order_id) VALUES ($1, $2, $3, $4);',
    ...
    async updateList({
        ...
        try {
            await this.#dbClient.query(
                'UPDATE public.lists SET med = $2, count = $3 WHERE id = $1;',
                [id, med_name, count]
            );
        } catch(error) {
    ...
    async deleteOrder({order_id} = {order_id: null}) {
        ...
        try {
            await this.#dbClient.query(
                'DELETE FROM public.lists WHERE order_id = $1;',
                [order_id]
            );
            await this.#dbClient.query(
